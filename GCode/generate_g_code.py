...
flipper_drop_pos = (flipper_pickup_pos[0], flipper_pickup_pos[1]+43)       # mm
travel_height = 30              # mm
...
def update_grid(previous_image, updated_image):
    ...
    '''
    for r in range(len(previous_image[0])):
        #print(r)
        for c in range(len(previous_image)):
            if previous_image[c][r] != updated_image[c][r]:
...
dino = image_to_array(r"C:\Users\jbrown\Documents\GitHub\tile_placer\Image Conversion\test_images\dino.png", (22, 18))
#place_empty_grid((22, 18), text_file)
#generate_all_images(image_paths)
update_grid(numpy.zeros((18, 22)), dino)
text_file.close()
