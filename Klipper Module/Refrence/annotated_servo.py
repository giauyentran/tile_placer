...
class PrinterServo:
    def __init__(self, config):
        # Get parameters from config file and setup variables
        ...
        # Main servo moves - if servo angle is not what is request... move to angle?
        ...
        # Register commands, for calling in Gcode commands?
...
# Do all modules have this? Something to check
